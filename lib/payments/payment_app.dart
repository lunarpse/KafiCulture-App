...
import 'package:project_2/payments/bloc/payment_page_bloc.dart';
...
class _PaymentAppState extends ConsumerState {
  ...
  Widget build(BuildContext context) {
    ...
    final PaymentPageBloc paymentPageBloc=PaymentPageBloc();
    return BlocConsumer<PaymentPageBloc, PaymentPageState>(
      bloc: paymentPageBloc,
      listenWhen: (previous, current) => current is PaymentpageActionState,
      buildWhen: (previous, current) => current is !PaymentpageActionState,
      listener: (context, state) {
        if(state is PaymentPageSwapConfirmState){
                      ...
                      Column(
                        children: [
                          ...
                          CompanyName(
                            ...
                            factor: 0.01,
                            pointsUsed:
                                (h_mEquivalent * 100).toStringAsFixed(2),
                            child: Slider(
                              divisions: 100,
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              onTap: () {
                                paymentPageBloc.add(PaymentPageSwapConfirmEvent());
